...
RESPONSIBILITY_CANDIDATES = [
    {
        ...
        "aira_target": "aira.benchmark and future bounded experiment runners",
        "migration_action": "Split domain benchmark execution from ARA platform orchestration.",
    ...
    },
    {
        ...
        "aira_target": "AIRA runner interface; ARA keeps platform-level safety policy.",
        "migration_action": "Keep execution deterministic and expose result bundles to ARA.",
